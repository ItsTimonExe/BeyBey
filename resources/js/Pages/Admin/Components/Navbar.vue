        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <Link :href="route('admin.dashboard')" class="flex items-center justify-between mr-4">
                    <img src="@/assets/image/logo1.png" alt="logo" class="w-[120px]"/>
                </Link>
            ...
            <div class="flex items-center lg:order-2">
                ...
                <button
                    type="button"
                    class="flex items-center px-3 py-2 mx-3 text-sm bg-gray-600 text-gray-300 rounded-full shadow-md transition hover:bg-gray-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-white"
                    id="user-menu-button"
                    aria-expanded="false"
                ...
                >
                    ...
                    <svg
                        ...
                        height="24px"
                        viewBox="0 0 24 24"
                        class="mr-2 hover:fill-primary-500 transition transform duration-300 ease-in-out"
                    >
                    ...
                    <p v-if="user" class="text-sm font-medium truncate">{{ user.name }}</p>
                </button>
                ...
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                        ...
                        <li>
                            <a href="/"
                               class="flex items-center py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                ...
                                <svg class="mr-2 w-5 h-5 text-gray-400"
                  ...
                  <ul class=" flex justify-center items-center  text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                    <li >
                      <Link :href="route('logout')" method="post" as="button"
                            class="block cursor-pointer py-2 px-4 text-sm text-center hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white ">
                        Sign out
                      </Link>
                    </li>
                  </ul>
